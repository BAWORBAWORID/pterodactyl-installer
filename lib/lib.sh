...
# customized for use with the Pterodactyl Panel. This fork is          #
...
# download URLs
export PANEL_DL_URL="https://github.com/BAWORBAWORID/panel/releases/latest/download/panel.zip"
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/BAWORBAWORID/pterodactyl-installer"}
...
welcome() {
  ...
  print_brake 70
  output "Pterodactyl Installer @ $SCRIPT_RELEASE"
  output ""
  output "Maintained by AlwaysCodex"
  output "support@alwayscodex.my.id | https://alwayscodex.my.id"
  output ""
  output "Original work by Vilhelm Prytz <vilhelm@prytznet.se>"
